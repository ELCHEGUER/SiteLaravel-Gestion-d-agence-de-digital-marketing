        ...
        <div class="row">
            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    {{-- form  --}}
                    <div class="row">
                        <form method="POST" action="{{ route('admin.gestion.charge.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row" style="text-align: center">
                                    <div class="col-6">
                                        <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                            <h6 class="text-white text-capitalize ps-3">Charge Information</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="container form-inputs">
                                    <div class="row" >
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Charge Name</label>
                                                <input type="text" name="name" value="{{ old('name') }}" class="form-control  @error('name') is-invalid @enderror" id="" placeholder="Entre Charge Name" />
                                                @error('name')
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="price"  value="{{ old('price') }}" class="form-control  @error('price') is-invalid @enderror"  id=""  placeholder="Enter Charge Price" />
                                                @error('price')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <button class="btn btn-success" type="submit" ><a style="color: aliceblue" href="{{ route('admin.gestion.charge.index') }}">Back</a></button>
                                    </div>
                                </div>
                            </div>
                        </form>
