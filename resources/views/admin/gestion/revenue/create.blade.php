    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Charge</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Revenue</h6>
            </nav>
        ...
        <div class="row">
            ...
            <div class="card my-4">
                ...
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Add New Revenue</h6>
                </div>
                </div>
                <div class="card-body px-0 pb-2">
                    {{-- form  --}}
                    <div class="row">
                        <form method="POST" action="{{ route('admin.gestion.revenue.store')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row" style="text-align: center">
                                    <div class="col-6">
                                        <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                            <h6 class="text-white text-capitalize ps-3">Revenue Information</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row" >
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control" id="" placeholder="Entre revenue Name" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Price</label>
                                                <input type="text" name="price" class="form-control" id=""  placeholder="Enter revenue price" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <button class="btn btn-success" type="submit" ><a style="color: aliceblue" href="{{ route('admin.gestion.revenue.index') }}">Back</a></button>
                                    </div>
                                </div>
                            </div>
                        </form>
