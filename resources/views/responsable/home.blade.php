          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">All Client</p>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Tasks Not Done</p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <form method="post" action="{{ route('responsable.home', ['id' => $item->id]) }}">
                                @csrf
                                @method('patch')
