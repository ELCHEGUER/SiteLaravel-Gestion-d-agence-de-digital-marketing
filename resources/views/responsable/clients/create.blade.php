        ...
        <div class="row">
            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    {{-- form  --}}
                    <div class="row">
                        <form method="POST" action="{{ route('respo.clients.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row" style="text-align: center">
                                    <div class="col-6">
                                        <div class="bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                                            <h6 class="text-white text-capitalize ps-3">Client Information</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="phone" class="form-control" id=""  placeholder="Enter Task Date" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" >
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="email" class="form-control" id="" placeholder="Entre Task Name" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Company Name</label>
                                                <input type="text" name="company" class="form-control" id=""  placeholder="Enter Task Date" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <button class="btn btn-success" type="submit" ><a style="color: aliceblue" href="{{ route('admin.clients.index') }}">Back</a></button>
                                    </div>
                                </div>
                            </div>
                        </form>
